...
namespace Project.COMMON.Tools
{
    ...
    {
        public static void Send(string receiver,string password= "123.321.", string body="Test mesajıdır",string subject="Email Testi",string sender= "brs.test.mail.123@gmail.com")
        {
