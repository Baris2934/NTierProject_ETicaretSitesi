...
namespace Project.MVCUI.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        // Aşağıdaki Action'da parametre olarak istenen id, aslında CategoryID'sidir. ProductID'si değildir...
        ...
        [HttpPost]
        public ActionResult AddProduct(Product product, HttpPostedFileBase resim) // Ürüne resim yüklemek için..
        {
